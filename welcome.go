...
`)
	...
	fmt.Println("Author: Valtteri Virtanen")
	fmt.Println("Mail: *@*")
	fmt.Println("Student ID: *")

	fmt.Println("Motive: Excercise for course TIETS02 Automaatit I 2018 - 2019, University of Tampere")

	fmt.Println("****************************************************************************************************")

	fmt.Println("Instructions for usage:")
	fmt.Printf(`
